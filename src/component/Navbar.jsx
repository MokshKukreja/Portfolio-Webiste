    ...
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#25274d] text-gray-300'>
      ...
      <ul
        className={
          !nav
            ? 'hidden'
            : 'absolute top-0 left-0 w-full h-screen bg-[#25274d] flex flex-col justify-center items-center'
        }
      >
      ...
      {/* Social icons */}
      <div className='hidden lg:flex md:flex  fixed flex-col top-[35%] left-0 '>
        <ul>
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#ce5050]'>
